...
public:
	...
	virtual void step()
	{
		...
		if (spawnTimer == 2100 || spawnTimer == 2150 || spawnTimer == 2200)
		{
		...
		if (spawnTimer == 2600 || spawnTimer == 2650 || spawnTimer == 2700)
		{
			factory.spawnImp(spr_imp2, imp2Spd, imp2MSpd, imp2HP, imp2Range, imp2Dmg, -250, -250, 50, 60);
		}
