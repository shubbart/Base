...
class Level5 : public BaseState
{
	...
	unsigned spr_background, spr_player, spr_shield, spr_iceblast, spr_flamerune, spr_demonbolt, spr_explosion, spr_death, spr_fireball, spr_font, spr_mouse,
		spr_portal, spr_imp, spr_impA, spr_impD, spr_imp2, spr_imp2D, spr_fire, spr_mage, spr_mageA, spr_mageD, spr_boss, spr_bossD;
...
public:
	...
	virtual void init()
	{
		...
		spr_boss = sfw::loadTextureMap("../res/boss.png", 4, 4);
		spr_bossD = sfw::loadTextureMap("../res/boss_death.png", 7, 1);
	}
	...
	virtual void step()
	{
		...
		if (pSpawner == 250)
		{
			factory.spawnPortal(spr_portal, 0, 250, 200, 200);
		}
		...
		if (spawnTimer == 800)
		{
			factory.spawnImp(spr_boss, bossSpd, bossSpd, bossHP, bossRange, bossDmg, bossX, bossY, 140, 150);
		}
